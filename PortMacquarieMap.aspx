<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortMacquarieMap.aspx.cs" Inherits="COMP3851_Team_1.PortMacquarieMap" %>
...
<body style="background-color: white;">
    ...
    <div class="projects-horizontal"
        ...
        <div class="container">
            ...
            <br>
    <center>
        <h4 style="color:#6495ed;"><strong>&nbsp;Port Macquarie Campus</strong></h4><br />
        <iframe width="800" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://use.mazemap.com/embed.html#v=1&config=UoNCampus&zlevel=1&center=152.890974,-31.439699&zoom=17.2&campusid=203&utm_medium=iframe" allow="geolocation"></iframe><br/>
    </center>
</body>
</html>
