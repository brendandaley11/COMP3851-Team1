<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProgramAdvisors.aspx.cs" Inherits="COMP3851_Team_1.ProgramAdvisors" %>
...
<div class="photo-gallery"></div>
    <div class="projects-horizontal"
        ...
        <br />
        <br />
		<h4 style="color:#6495ed;"><strong>&nbsp;Program Advisors</strong></h4>
        <p class="text-center" style="color: black;">Here is a complete, up-to-date list of all Program Advisors for UoN. Program Convenors help you understand program requirements, rules and structure, as well as helping you check your academic progress.<br></p>
		<p class="text-center" style="color: black;">The best way to contact your Program Advisor is via email: ProgramAdvice@newcastle.edu.au<br></p>
            <br>
            <p>
                <label>
                    Faculty:
		...
		<br><br>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:BoundField DataField="ProgramAdvisor" HeaderText="Program Advisor" SortExpression="ProgramAdvisor" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:COMP3851_Team1ConnectionString %>" SelectCommand="SELECT * FROM [ProgramAdvisors] ORDER BY [Faculty]"></asp:SqlDataSource>
            <br><br><br>
