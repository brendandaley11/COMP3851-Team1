<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewcastleMap.aspx.cs" Inherits="COMP3851_Team_1.NewcastleMap" %>
...
<nav class="navbar navbar-light navbar-expand-md navigation-clean-search" style="width: 120;">
    ...
    <div class="projects-horizontal"
        ...
        <div class="container">
            ...
            <br>
    <center>
        <h4 style="color:#6495ed;"><strong>&nbsp;Newcastle CBD Campus</strong></h4><br />
        <iframe width="800" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://use.mazemap.com/embed.html#v=1&config=UoNCampus&center=151.770759,-32.927484&zoom=16.6&zlevel=1&campusid=128&utm_medium=iframe" allow="geolocation"></iframe><br/>
    </center>
</body>
</html>
