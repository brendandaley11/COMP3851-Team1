<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CallaghanMap.aspx.cs" Inherits="COMP3851_Team_1.CallaghanMap" %>
...
<body style="background-color: white;">
    ...
    <div class="projects-horizontal"
        ...
        <div class="container">
            ...
            <br>
    <center>
        <h4 style="color:#6495ed;"><strong>&nbsp;Callaghan Campus</strong></h4><br />
        <iframe width="800" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://use.mazemap.com/embed.html#v=1&config=UoNCampus&center=151.706167,-32.891064&zoom=15.2&zlevel=2&campusid=117&utm_medium=iframe" allow="geolocation"></iframe><br/>
    </center>
</body>
</html>
