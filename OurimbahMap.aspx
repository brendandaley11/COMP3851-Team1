<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OurimbahMap.aspx.cs" Inherits="COMP3851_Team_1.OurimbahMap" %>
...
<nav class="navbar navbar-light navbar-expand-md navigation-clean-search" style="width: 120;">
    ...
    <div class="projects-horizontal"
        ...
        <div class="container">
            ...
            <br>
    <center>
        <h4 style="color:#6495ed;"><strong>&nbsp;Ourimbah Campus</strong></h4><br />
        <iframe width="800" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://use.mazemap.com/embed.html#v=1&config=UoNCampus&zlevel=1&center=151.377904,-33.357500&zoom=16.2&campusid=193&utm_medium=iframe" allow="geolocation"></iframe><br/>
    </center>
</body>
</html>
